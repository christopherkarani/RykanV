    ...
    [_]CommandInfo{
        .{
            ...
            .details = &.{
                ...
                "--seatbelt-profile compatible|hardened|strict (macOS only; default hardened; also ORCA_SEATBELT_PROFILE) sets residual grade: compatible is the historical broad process*/private/var residual; hardened narrows process ops and bootstrap FS; strict also drops inbound/bind under route-force and omits broad network* without route force. Still not process/XPC isolation. Use compatible if a tool breaks under hardened.",
        ...
        .{
            ...
            .examples = &.{
                ...
                "ryk tools classify send_email --policy .orca/policy.yaml",
                "ryk tools packs",
            },
            .details = &.{
